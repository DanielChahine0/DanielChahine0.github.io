            ...
            <div className="mx-auto max-w-5xl w-full grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div className="space-y-4 md:col-span-2 flex flex-col justify-center">
                    <h1 className="flex items-center gap-3 text-3xl font-bold md:text-4xl mb-2">
                        <span>Hey, I'm</span>
                        <span className="text-primary">Daniel Chahine</span>
                    </h1>
                    ...
                    <p className="text-left text-base leading-relaxed">
                        ...
                        <a
                            className="text-primary font-bold underline underline-offset-2 inline-block transition-transform duration-200 hover:scale-105"
                        ...
                        , a real-time MERN note-taking platform;{" "}
                        <a
                            className="text-primary font-bold underline underline-offset-2 inline-block transition-transform duration-200 hover:scale-105"
                        ...
                        , a self-hosted Google Calendar-style web app; and{" "}
                        <a
                            className="text-primary font-bold underline underline-offset-2 inline-block transition-transform duration-200 hover:scale-105"
