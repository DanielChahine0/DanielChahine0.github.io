        ...
        <PageTransition>
            <div className="min-h-screen flex flex-col bg-background relative overflow-hidden">
                ...
                <main className="mt-10 flex-1 container mx-auto px-4 py-8 relative z-10">
                    ...
                    >
                        <h1 className="text-4xl font-bold mb-4 tracking-tight bg-gradient-to-r from-indigo-400 via-fuchsia-400 to-pink-400 bg-clip-text text-transparent">Playground</h1>
                        ...
                        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {tools.map((tool, index) => {
                                ...
                                return (
                                    ...
                                    >
                                        <Link to={tool.path} aria-label={`Open ${tool.title} tool`} tabIndex={0} className="focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-400 rounded-lg">
                                            <div className="bg-card rounded-lg p-6 shadow-md hover:shadow-2xl transition-all duration-300 hover:-translate-y-1 group border border-transparent hover:border-indigo-300 focus-within:border-indigo-400">
                                                ...
                                                <button className="mt-2 px-4 py-2 bg-indigo-500 text-white rounded-md shadow hover:bg-indigo-600 focus:outline-none focus:ring-2 focus:ring-indigo-400 focus:ring-offset-2 transition-all text-sm font-medium opacity-0 group-hover:opacity-100 group-focus-within:opacity-100" tabIndex={-1} aria-label={`Try out ${tool.title}`}>
