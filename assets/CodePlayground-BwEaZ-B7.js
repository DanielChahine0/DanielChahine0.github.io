...
});`}],G=t.lazy(()=>M(()=>import("./EditorPanel-Ccxt7cKX.js"),__vite__mapDeps([0,1,2,3]))),X=t.lazy(()=>M(()=>import("./PreviewPanel-dvM05nLz.js"),__vite__mapDeps([4,1,2,5]))),Ce=t.lazy(()=>M(()=>import("./SavedProjectsPanel-Dp7ZMiwO.js"),__vite__mapDeps([6,1,2]))),Se="codePlaygroundProjects",Ne=800,Ee=768,O={html:`<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
